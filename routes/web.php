...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/trades/export-pdf', [TradesController::class, 'exportPdf'])->name('trades.export-pdf');
    Route::get('/trades/{position}', [TradesController::class, 'show'])->name('trades.show');
    Route::patch('/trades/{position}/market-price', [TradesController::class, 'updateMarketPrice'])->name('trades.market-price.update');
    ...
    Route::patch('/settings/balances/{balance}', [App\Http\Controllers\SettingsController::class, 'updateBalance'])->name('settings.balances.update');
    ...
    Route::post('/settings/accounts', [App\Http\Controllers\AccountsController::class, 'store'])->name('settings.accounts.store');
    Route::patch('/settings/accounts/{account}', [App\Http\Controllers\AccountsController::class, 'update'])->name('settings.accounts.update');
    Route::delete('/settings/accounts/{account}', [App\Http\Controllers\AccountsController::class, 'destroy'])->name('settings.accounts.destroy');
