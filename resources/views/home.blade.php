...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>{{ config('app.name', 'Tradelog') }} - Transform Your Trading Journey | Advanced Trading Analytics & Journal</title>
    <meta name="title" content="Tradelog - Transform Your Trading Journey | Advanced Trading Analytics & Journal">
    <meta name="description" content="Master your trades with intelligent analytics, automated tracking, and insightful journaling. Track P&L, analyze performance, and improve your trading with Tradelog - the complete trading journal and analytics platform.">
    ...
    <meta name="author" content="Tradelog">
    ...
    <meta property="og:title" content="Tradelog - Transform Your Trading Journey">
    ...
    <meta property="og:site_name" content="Tradelog">
    <meta property="og:locale" content="en_US">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url('/') }}">
    <meta property="twitter:title" content="Tradelog - Transform Your Trading Journey">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-2xl font-bold text-white">Tradelog</span>
                </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gradient-to-br from-gray-50 to-white rounded-xl shadow-lg p-8 border border-gray-100">
                    ...
                    <p class="text-gray-600 mb-6 italic">
                        "Tradelog completely transformed how I track my trades. The analytics are incredibly detailed and the auto-import saves me hours every week!"
                    </p>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-white rounded-xl shadow-lg p-8 border border-gray-100">
                    ...
                    <p class="text-gray-600 mb-6 italic">
                        "As a professional trader, I need accurate P&L tracking. Tradelog's FIFO position management is spot-on and the UI is beautiful!"
                    </p>
                    <div class="flex items-center">
    ...
    <section class="gradient-bg py-20 relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-300 mb-8">
                Join thousands of traders who are already improving their performance with Tradelog
            </p>
    ...
    <footer class="bg-gray-900 text-gray-400 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8">
                <div class="col-span-2">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://github.com/habeebb21/Tradelog" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-orange-600 transition-colors">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-gray-800 mt-12 pt-8 text-center text-sm">
                <p>&copy; 2026 Tradelog. All rights reserved. Built with ❤️ for traders.</p>
            </div>
        </div>
    </footer>
